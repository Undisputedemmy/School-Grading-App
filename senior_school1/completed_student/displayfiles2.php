...
if (isset($_GET['admission_no'])) {
    ...
    $query = "SELECT * FROM z_mathematics2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $result = mysqli_query($con, $query);
    $fresult = mysqli_fetch_assoc($result);

            // Retrieve the results from the eng table
    $engResultQuery = "SELECT * FROM z_english2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $phyResultQuery = "SELECT * FROM z_physics2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $cheResultQuery = "SELECT * FROM z_chemistry2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $ecoResultQuery ="SELECT * FROM z_econs2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $bioResultQuery = "SELECT * FROM z_biology2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $crsResultQuery = "SELECT * FROM z_crs2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $agricResultQuery = "SELECT * FROM z_agric2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $dpResultQuery = "SELECT * FROM z_dp2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $dpResultResult = mysqli_query($con, $dpResultQuery);
    $dpResult = mysqli_fetch_assoc($dpResultResult);

    // Retrieve the results from the che table
    $civicResultQuery = "SELECT * FROM z_civic2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $civicResultResult = mysqli_query($con, $civicResultQuery);
    $civicResult = mysqli_fetch_assoc($civicResultResult);

    // Retrieve the results from the che table
    $accResultQuery = "SELECT * FROM z_accounting2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $accResultResult = mysqli_query($con, $accResultQuery);
    $accResult = mysqli_fetch_assoc($accResultResult);

    // Retrieve the results from the che table
    $yorResultQuery = "SELECT * FROM z_yoruba2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    ...
    $tecResultQuery = "SELECT * FROM z_techdraw2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $tecResultResult = mysqli_query($con, $tecResultQuery);
    $tecResult = mysqli_fetch_assoc($tecResultResult);

    // Retrieve the basic tech from the che table
    $histResultQuery = "SELECT * FROM z_history2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $histResultResult = mysqli_query($con, $histResultQuery);
    $histResult = mysqli_fetch_assoc($histResultResult);

    // Retrieve the basic tech from the che table
    $comResultQuery = "SELECT * FROM z_commerce2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $comResultResult = mysqli_query($con, $comResultQuery);
    $comResult = mysqli_fetch_assoc($comResultResult);

    // Retrieve the basic tech from the che table
    $artResultQuery = "SELECT * FROM z_artcraft2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $artResultResult = mysqli_query($con, $artResultQuery);
    $artResult = mysqli_fetch_assoc($artResultResult);

    // Retrieve the basic tech from the che table
    $catResultQuery = "SELECT * FROM z_catering2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $catResultResult = mysqli_query($con, $catResultQuery);
    $catResult = mysqli_fetch_assoc($catResultResult);

    // Retrieve the basic tech from the che table
    $f_mathResultQuery = "SELECT * FROM z_f_math2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $f_mathResultResult = mysqli_query($con, $f_mathResultQuery);
    $f_mathResult = mysqli_fetch_assoc($f_mathResultResult);

    // Retrieve the basic tech from the che table
    $frenchResultQuery = "SELECT * FROM z_french2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $frenchResultResult = mysqli_query($con, $frenchResultQuery);
    $frenchResult = mysqli_fetch_assoc($frenchResultResult);

    // Retrieve the basic tech from the che table
    $litResultQuery = "SELECT * FROM z_literature2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $litResultResult = mysqli_query($con, $litResultQuery);
    $litResult = mysqli_fetch_assoc($litResultResult);

    // Retrieve the basic tech from the che table
    $geoResultQuery = "SELECT * FROM z_geographyi2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $geoResultResult = mysqli_query($con, $geoResultQuery);
    $geoResult = mysqli_fetch_assoc($geoResultResult);

    // Retrieve the basic tech from the che table
    $govResultQuery = "SELECT * FROM z_government2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $govResultResult = mysqli_query($con, $govResultQuery);
    $govResult = mysqli_fetch_assoc($govResultResult);


    // Retrieve the basic tech from the che table
    $othResultQuery = "SELECT * FROM z_others2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
    $othResultResult = mysqli_query($con, $othResultQuery);
    $othResult = mysqli_fetch_assoc($othResultResult);

    $teaResultQuery = "SELECT * FROM z_t_comment2 WHERE student_id = (SELECT student_id FROM completed_student WHERE admission_no = '$studentId')";
