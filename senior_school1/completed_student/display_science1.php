...
<body>
    ...
    <div class="containter mt-0" style="display: flex;">
            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['z_agric1'];
                        $agricLowestScore = $lowestScores['z_agric1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['z_chemistry1'];
                        $cheLowestScore = $lowestScores['z_chemistry1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['z_physics1'];
                        $phyLowestScore = $lowestScores['z_physics1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($catResultResult) > 0) {
                        ...
                        $catHighestScore = $highestScores['z_catering1'];
                        $catLowestScore = $lowestScores['z_catering1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['z_techdraw1'];
                        $tecLowestScore = $lowestScores['z_techdraw1'];
