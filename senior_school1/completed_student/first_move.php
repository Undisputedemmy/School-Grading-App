...
function moveStudentSubjectsToZTables($admissionNo, $session)
{
    ...
    // Move principal comments from others table to z_comments1 table
    ...
    if (mysqli_num_rows($getCommentsResult) > 0) {
        while ($commentRow = mysqli_fetch_assoc($getCommentsResult)) {
            ...
            // Insert the comments into the z_comments1 table
    ...
    // Move teacher comments from t_comment table to z_t_comment1 table
    ...
    echo "Student with admission number $admissionNo: First term subjects, principal comments, and teacher comments moved successfully<br>";
}
...
<head>
    ...
    <title>Move Student Subjects, Principal Comments, and Teacher Comments</title>
</head>

<body>
    <div class="container my-2">
        <h1>Move Student Subjects, Principal Comments, and Teacher Comments</h1>
        <form method="POST">
            <div class="mb-3">
