    ...
    <div class="mywrap my-3">
        <div class="table-wrapper1">
            <table style="border: 2px solid;">
                ...
                <tr>
                    <td colspan="6" style="text-align: left;">Lit-In_Eng</td>
                    <?php
                    if (mysqli_num_rows($litResultResult) > 0) {
                        mysqli_data_seek($litResultResult, 0);
                        $litHighestScore = $highestScores['z_literature1'];
                        $litLowestScore = $lowestScores['z_literature1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($crsResultResult) > 0) {
                        ...
                        $crsHighestScore = $highestScores['z_crs1'];
                        $crsLowestScore = $lowestScores['z_crs1'];
