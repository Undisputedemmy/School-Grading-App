<?php
include 'connect.php';
include 'displayfiles3.php';
include 'highest_Z3.php';
include 'lowest_Z3.php';
            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($engResultResult) > 0) {
                        ...
                        $englishHighestScore = $highestScores['z_english'];
                        $englishLowestScore = $lowestScores['z_english'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        $mathHighestScore = $highestScores['z_mathematics'];
                        $mathLowestScore = $lowestScores['z_mathematics'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($f_mathResultResult) > 0) {
                        ...
                        $f_mathHighestScore = $highestScores['z_f_math'];
                        $f_mathLowestScore = $lowestScores['z_f_math'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($bioResultResult) > 0) {
                        ...
                        $bioHighestScore = $highestScores['z_biology'];
                        $bioLowestScore = $lowestScores['z_biology'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['z_agric'];
                        $agricLowestScore = $lowestScores['z_agric'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($ecoResultResult) > 0) {
                        ...
                        $ecoHighestScore = $highestScores['z_econs'];
                        $ecoLowestScore = $lowestScores['z_econs'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['z_chemistry'];
                        $cheLowestScore = $lowestScores['z_chemistry'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['z_physics'];
                        $phyLowestScore = $lowestScores['z_physics'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($dpResultResult) > 0) {
                        ...
                        $dpHighestScore = $highestScores['z_dp'];
                        $dpLowestScore = $lowestScores['z_dp'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($civicResultResult) > 0) {
                        ...
                        $civicHighestScore = $highestScores['z_civic'];
                        $civicLowestScore = $lowestScores['z_civic'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($catResultResult) > 0) {
                        ...
                        $catHighestScore = $highestScores['z_catering'];
                        $catLowestScore = $lowestScores['z_catering'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['z_techdraw'];
                        $tecLowestScore = $lowestScores['z_techdraw'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($yorResultResult) > 0) {
                        ...
                        $yorHighestScore = $highestScores['z_yoruba'];
                        $yorLowestScore = $lowestScores['z_yoruba'];
