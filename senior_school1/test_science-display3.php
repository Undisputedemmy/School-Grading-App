               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['test_agric3'];
                        $agricLowestScore = $lowestScores['test_agric3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['test_chemistry3'];
                        $cheLowestScore = $lowestScores['test_chemistry3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['test_physics3'];
                        $phyLowestScore = $lowestScores['test_physics3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['test_techdraw3'];
                        $tecLowestScore = $lowestScores['test_techdraw3'];
