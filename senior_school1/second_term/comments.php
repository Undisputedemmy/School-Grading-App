...
if (isset($_POST['submit'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the Remarks already exist in the others2 table for the given student
        $checkQuery = "SELECT * FROM others2 WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the Remarks into the others2 table with the associated student ID
            $sql = "INSERT INTO others2 (student_id, principal_remarks, principal_name, date)
