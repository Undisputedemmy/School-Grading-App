...
if (isset($_POST['submit'])) {
  ...
  $getmidtermScoreScoreQuery = "SELECT COALESCE(total_score, 0) AS midterm_score FROM test_government2 WHERE 
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Check if the scores already exist in the government table for the given student
    $checkQuery = "SELECT * FROM government2 WHERE student_id = '$studentDetailsId'";
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
      ...
      // Insert the result into the government table with the associated student ID
      $sql = "INSERT INTO government2 (student_id, midterm_score, exam_score, terminal_score, student_grade)
