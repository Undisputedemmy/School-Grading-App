               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($comResultResult) > 0) {
                        ...
                        $comHighestScore = $highestScores['commerce1'];
                        $comLowestScore = $lowestScores['commerce1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($accResultResult) > 0) {
                        ...
                        $accHighestScore = $highestScores['accounting1'];
                        $accLowestScore = $lowestScores['accounting1'];
