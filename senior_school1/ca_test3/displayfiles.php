...
if (isset($_GET['admission_no'])) {
    ...
    $phyResultQuery = "SELECT ph.*, sd.admission_no, sd.name, sd.class FROM test_physics3 ph, student_details sd WHERE sd.id = ph.student_id AND sd.admission_no = '$studentId'";
    ...
    $cheResultQuery = "SELECT ch.*, sd.admission_no, sd.name, sd.class FROM test_chemistry3 ch, student_details sd WHERE sd.id = ch.student_id AND sd.admission_no = '$studentId'";
    ...
    $ecoResultQuery = "SELECT ec.*, sd.admission_no, sd.name, sd.class FROM test_econs3 ec, student_details sd WHERE sd.id = ec.student_id AND sd.admission_no = '$studentId'";
    ...
    $bioResultQuery = "SELECT bi.*, sd.admission_no, sd.name, sd.class FROM test_biology3 bi, student_details sd WHERE sd.id = bi.student_id AND sd.admission_no = '$studentId'";
    ...
    $agricResultQuery = "SELECT ag.*, sd.admission_no, sd.name, sd.class FROM test_agric3 ag, student_details sd WHERE sd.id = ag.student_id AND sd.admission_no = '$studentId'";
    ...
    $dpResultQuery = "SELECT co.*, sd.admission_no, sd.name, sd.class FROM test_dp3 co, student_details sd WHERE sd.id = co.student_id AND sd.admission_no = '$studentId'";
    $dpResultResult = mysqli_query($con, $dpResultQuery);
    $dpResult = mysqli_fetch_assoc($dpResultResult);

    // Retrieve the results from the che table
    $civicResultQuery = "SELECT ci.*, sd.admission_no, sd.name, sd.class FROM test_civic3 ci, student_details sd WHERE sd.id = ci.student_id AND sd.admission_no = '$studentId'";
    $civicResultResult = mysqli_query($con, $civicResultQuery);
    $civicResult = mysqli_fetch_assoc($civicResultResult);

    // Retrieve the results from the che table
    $accResultQuery = "SELECT bt.*, sd.admission_no, sd.name, sd.class FROM test_accounting3 bt, student_details sd WHERE sd.id = bt.student_id AND sd.admission_no = '$studentId'";
    ...
    $tecResultQuery = "SELECT te.*, sd.admission_no, sd.name, sd.class FROM test_techdraw3 te, student_details sd WHERE sd.id = te.student_id AND sd.admission_no = '$studentId'";
    ...
    // Retrieve the basic tech from the che table
    $comResultQuery = "SELECT se.*, sd.admission_no, sd.name, sd.class FROM test_commerce3 se, student_details sd WHERE sd.id = se.student_id AND sd.admission_no = '$studentId'";
    ...
    // Retrieve the basic tech from the che table
    $catResultQuery = "SELECT cc.*, sd.admission_no, sd.name, sd.class FROM test_catering3 cc, student_details sd WHERE sd.id = cc.student_id AND sd.admission_no = '$studentId'";
    $catResultResult = mysqli_query($con, $catResultQuery);
    $catResult = mysqli_fetch_assoc($catResultResult);

    // Retrieve the basic tech from the che table
    $f_mathResultQuery = "SELECT mu.*, sd.admission_no, sd.name, sd.class FROM test_f_math3 mu, student_details sd WHERE sd.id = mu.student_id AND sd.admission_no = '$studentId'";
    ...
    // Retrieve the basic tech from the che table
    $litResultQuery = "SELECT li.*, sd.admission_no, sd.name, sd.class FROM test_literature3 li, student_details sd WHERE sd.id = li.student_id AND sd.admission_no = '$studentId'";
    $litResultResult = mysqli_query($con, $litResultQuery);
    $litResult = mysqli_fetch_assoc($litResultResult);

    // Retrieve the basic tech from the che table
    $geoResultQuery = "SELECT gr.*, sd.admission_no, sd.name, sd.class FROM test_geographyi3 gr, student_details sd WHERE sd.id = gr.student_id AND sd.admission_no = '$studentId'";
    $geoResultResult = mysqli_query($con, $geoResultQuery);
    $geoResult = mysqli_fetch_assoc($geoResultResult);

    // Retrieve the basic tech from the che table
    $govResultQuery = "SELECT gv.*, sd.admission_no, sd.name, sd.class FROM test_government3 gv, student_details sd WHERE sd.id = gv.student_id AND sd.admission_no = '$studentId'";
