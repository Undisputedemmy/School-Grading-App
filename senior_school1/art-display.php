            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($litResultResult) > 0) {
                        ...
                        $litHighestScore = $highestScores['literature'];
                        $litLowestScore = $lowestScores['literature'];
                    ...
                    ?>
                            ...
                            <td><?php echo ($litSubjectResult['firstterm_score'] != 0) ? $litSubjectResult['firstterm_score'] : "-"; ?></td>
                            <td><?php echo ($litSubjectResult['secondterm_score'] != 0) ? $litSubjectResult['secondterm_score'] : "-"; ?></td>
                            <td><?php echo ($litSubjectResult['cumulative_score'] != 0) ? $litSubjectResult['cumulative_score'] : "-"; ?></td>
