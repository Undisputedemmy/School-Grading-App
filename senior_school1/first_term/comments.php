...
if (isset($_POST['submit'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the Remarks already exist in the others1 table for the given student
        $checkQuery = "SELECT * FROM others1 WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the Remarks into the others1 table with the associated student ID
            $sql = "INSERT INTO others1 (student_id, principal_remarks, principal_name, date)
