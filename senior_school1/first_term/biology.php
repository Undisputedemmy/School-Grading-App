...
if (isset($_POST['submit'])) {
    ...
    $getmidtermScoreScoreQuery = "SELECT COALESCE(total_score, 0) AS midterm_score FROM test_biology1 WHERE 
...
$examScore = $_POST['exam_score'];
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $checkQuery = "SELECT * FROM biology1 WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            $sql = "INSERT INTO biology1 (student_id, midterm_score, exam_score, terminal_score, student_grade)
