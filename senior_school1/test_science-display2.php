               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['test_agric2'];
                        $agricLowestScore = $lowestScores['test_agric2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['test_chemistry2'];
                        $cheLowestScore = $lowestScores['test_chemistry2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['test_physics2'];
                        $phyLowestScore = $lowestScores['test_physics2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($catResultResult) > 0) {
                        ...
                        $catHighestScore = $highestScores['test_catering2'];
                        $catLowestScore = $lowestScores['test_catering2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['test_techdraw2'];
                        $tecLowestScore = $lowestScores['test_techdraw2'];
