...
if (isset($_POST['submit'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the comment already exists in the t_comment table for the given student
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the comment into the t_comment table with the associated student ID
