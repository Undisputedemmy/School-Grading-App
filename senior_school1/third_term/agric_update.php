...
if (isset($_POST['submit'])) {
  ...
  student_id = (SELECT id FROM student_details WHERE admission_no = '$studentId')";
    ...
    // Determine the student grade based on the cumulative score
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Update the result in the agric table with the associated student ID
        $updateSql = "UPDATE agric SET
