...
if (isset($_POST['submit'])) {
    ...
    // Retrieve the first term score from the geographyi1 table
    $getFirstTermScoreQuery = "SELECT COALESCE(terminal_score, 0) AS firstterm_score FROM geographyi1 WHERE 
    ...
    // Retrieve the second term score from the geographyi2 table
    $getSecondTermScoreQuery = "SELECT COALESCE(terminal_score, 0) AS secondterm_score FROM geographyi2 WHERE 
    student_id = (SELECT id FROM student_details WHERE admission_no = '$studentId')";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the scores already exist in the geographyi table for the given student
        $checkQuery = "SELECT * FROM geographyi WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the result into the geographyi table with the associated student ID
            $sql = "INSERT INTO geographyi (student_id, midterm_score, exam_score, terminal_score, firstterm_score, secondterm_score, cumulative_score, student_grade)
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="midterm_score" required min="0" max="30">
                    </div>
                    <div class="mb-3">
