               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($comResultResult) > 0) {
                        ...
                        $comHighestScore = $highestScores['test_commerce3'];
                        $comLowestScore = $lowestScores['test_commerce3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($accResultResult) > 0) {
                        ...
                        $accHighestScore = $highestScores['test_accounting3'];
                        $accLowestScore = $lowestScores['test_accounting3'];
