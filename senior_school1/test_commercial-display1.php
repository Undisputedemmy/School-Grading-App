               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($comResultResult) > 0) {
                        ...
                        $comHighestScore = $highestScores['test_commerce1'];
                        $comLowestScore = $lowestScores['test_commerce1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($accResultResult) > 0) {
                        ...
                        $accHighestScore = $highestScores['test_accounting1'];
                        $accLowestScore = $lowestScores['test_accounting1'];
