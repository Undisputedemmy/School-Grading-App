<?php
include 'connect.php';
include './ca_test3/displayfiles.php';
include './ca_test3/highest_score.php';
include './ca_test3/lowest_score.php';
            ...
            <table style="border: 2px solid;">
               ...
               <tr>
                    ...
                    if (mysqli_num_rows($engResultResult) > 0) {
                        ...
                        $englishHighestScore = $highestScores['test_english3'];
                        $englishLowestScore = $lowestScores['test_english3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        $mathHighestScore = $highestScores['test_mathematics3'];
                        $mathLowestScore = $lowestScores['test_mathematics3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($f_mathResultResult) > 0) {
                        ...
                        $f_mathHighestScore = $highestScores['test_f_math3'];
                        $f_mathLowestScore = $lowestScores['test_f_math3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($bioResultResult) > 0) {
                        ...
                        $bioHighestScore = $highestScores['test_biology3'];
                        $bioLowestScore = $lowestScores['test_biology3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($ecoResultResult) > 0) {
                        ...
                        $ecoHighestScore = $highestScores['test_econs3'];
                        $ecoLowestScore = $lowestScores['test_econs3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($litResultResult) > 0) {
                        ...
                        $litHighestScore = $highestScores['test_literature3'];
                        $litLowestScore = $lowestScores['test_literature3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($dpResultResult) > 0) {
                        ...
                        $dpHighestScore = $highestScores['test_dp3'];
                        $dpLowestScore = $lowestScores['test_dp3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($civicResultResult) > 0) {
                        ...
                        $civicHighestScore = $highestScores['test_civic3'];
                        $civicLowestScore = $lowestScores['test_civic3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($govResultResult) > 0) {
                        ...
                        $govHighestScore = $highestScores['test_government3'];
                        $govLowestScore = $lowestScores['test_government3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($catResultResult) > 0) {
                        ...
                        $catHighestScore = $highestScores['test_catering3'];
                        $catLowestScore = $lowestScores['test_catering3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($crsResultResult) > 0) {
                        ...
                        $crsHighestScore = $highestScores['test_crs3'];
                        $crsLowestScore = $lowestScores['test_crs3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($histResultResult) > 0) {
                        ...
                        $histHighestScore = $highestScores['test_history3'];
                        $histLowestScore = $lowestScores['test_history3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($yorResultResult) > 0) {
                        ...
                        $yorHighestScore = $highestScores['test_yoruba3'];
                        $yorLowestScore = $lowestScores['test_yoruba3'];
