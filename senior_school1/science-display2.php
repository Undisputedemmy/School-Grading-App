               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['agric2'];
                        $agricLowestScore = $lowestScores['agric2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['chemistry2'];
                        $cheLowestScore = $lowestScores['chemistry2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['physics2'];
                        $phyLowestScore = $lowestScores['physics2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($catResultResult) > 0) {
                        ...
                        $catHighestScore = $highestScores['catering2'];
                        $catLowestScore = $lowestScores['catering2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['techdraw2'];
                        $tecLowestScore = $lowestScores['techdraw2'];
