...
<body>
    <nav>
        ...
        <li><a href="test_commentsform.php">Comments</a></li>
        </ul>
        </li>
        <li><a href="#">Sheets</a>
        <ul>
        ...
        <li><a href="../promoteview4.php">Promote</a></li>
            ...
            <tbody>
                ...
                if ($result) {
                        ...
                        echo '<tr>
                            ...
                            <td>
                                <button class="btn btn-primary">
                                    <a href="senior1-profile.php?admission_no=' . $admission_no . '" class="text-light" style="text-decoration: none;">View Profile</a>
                                </button>
                            </td>
                        </tr>';
                        $count++;
                    ...
                    if ($rowCount > $offset + $studentsPerPage) {
                        echo '<tr><td colspan="5"><a href="senior1.php?page=' . $nextPage . '">Next Page</a></td></tr>';
                    }
                } else {
