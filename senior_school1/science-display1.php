               ...
               <tr>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($agricResultResult) > 0) {
                        ...
                        $agricHighestScore = $highestScores['agric1'];
                        $agricLowestScore = $lowestScores['agric1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($cheResultResult) > 0) {
                        ...
                        $cheHighestScore = $highestScores['chemistry1'];
                        $cheLowestScore = $lowestScores['chemistry1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($phyResultResult) > 0) {
                        ...
                        $phyHighestScore = $highestScores['physics1'];
                        $phyLowestScore = $lowestScores['physics1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($tecResultResult) > 0) {
                        ...
                        $tecHighestScore = $highestScores['techdraw1'];
                        $tecLowestScore = $lowestScores['techdraw1'];
