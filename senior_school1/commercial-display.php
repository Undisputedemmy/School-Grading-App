            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($comResultResult) > 0) {
                        ...
                        $comHighestScore = $highestScores['commerce'];
                        $comLowestScore = $lowestScores['commerce'];
                    ...
                    ?>
                            ...
                            <td><?php echo ($comSubjectResult['firstterm_score'] != 0) ? $comSubjectResult['firstterm_score'] : "-"; ?></td>
                            <td><?php echo ($comSubjectResult['secondterm_score'] != 0) ? $comSubjectResult['secondterm_score'] : "-"; ?></td>
                            <td><?php echo ($comSubjectResult['cumulative_score'] != 0) ? $comSubjectResult['cumulative_score'] : "-"; ?></td>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($govResultResult) > 0) {
                        ...
                        $govHighestScore = $highestScores['government'];
                        $govLowestScore = $lowestScores['government'];
                    ...
                    ?>
                            ...
                            <td><?php echo ($govSubjectResult['firstterm_score'] != 0) ? $govSubjectResult['firstterm_score'] : "-"; ?></td>
                            <td><?php echo ($govSubjectResult['secondterm_score'] != 0) ? $govSubjectResult['secondterm_score'] : "-"; ?></td>
                            <td><?php echo ($govSubjectResult['cumulative_score'] != 0) ? $govSubjectResult['cumulative_score'] : "-"; ?></td>
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($accResultResult) > 0) {
                        ...
                        $accHighestScore = $highestScores['accounting'];
                        $accLowestScore = $lowestScores['accounting'];
                    ...
                    ?>
                            ...
                            <td><?php echo ($accSubjectResult['firstterm_score'] != 0) ? $accSubjectResult['firstterm_score'] : "-"; ?></td>
                            <td><?php echo ($accSubjectResult['secondterm_score'] != 0) ? $accSubjectResult['secondterm_score'] : "-"; ?></td>
                            <td><?php echo ($accSubjectResult['cumulative_score'] != 0) ? $accSubjectResult['cumulative_score'] : "-"; ?></td>
