...
if (isset($_POST['submit'])) {
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    $checkQuery = "SELECT * FROM test_english1 WHERE student_id = '$studentDetailsId'";
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
      ...
      $sql = "INSERT INTO test_english1 (student_id, class_exercise, assignment, total_score, test, student_grade)
