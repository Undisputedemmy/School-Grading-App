...
if (isset($_POST['submit'])) {
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Check if the scores already exist in the test_geographyi table for the given student
    $checkQuery = "SELECT * FROM test_geographyi1 WHERE student_id = '$studentDetailsId'";
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
      ...
      // Insert the result into the test_geographyi table with the associated student ID
      $sql = "INSERT INTO test_geographyi1 (student_id, class_exercise, assignment, total_score, test, student_grade)
      ...
      if ($res) {
        ...
        $message = "test_geographyi scores submitted successfully!";
