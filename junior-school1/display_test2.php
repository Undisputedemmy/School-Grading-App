...
include './ca_test2/position.php';
include './ca_test2/lowest_percentage.php';
            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($bstResultResult) > 0) {
                        ...
                        $bstHighestScore = $highestScores['test_bst2'];
                        $bstLowestScore = $lowestScores['test_bst2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($pvsResultResult) > 0) {
                        ...
                        $pvsHighestScore = $highestScores['test_pvs2'];
                        $pvsLowestScore = $lowestScores['test_pvs2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($nvResultResult) > 0) {
                        ...
                        $nvHighestScore = $highestScores['test_nv2'];
                        $nvLowestScore = $lowestScores['test_nv2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($crsResultResult) > 0) {
                        ...
                        $crsHighestScore = $highestScores['test_crs2'];
                        $crsLowestScore = $lowestScores['test_crs2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($busResultResult) > 0) {
                        ...
                        $busHighestScore = $highestScores['test_business2'];
                        $busLowestScore = $lowestScores['test_business2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($ccaResultResult) > 0) {
                        ...
                        $ccaHighestScore = $highestScores['test_cca2'];
                        $ccaLowestScore = $lowestScores['test_cca2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($frenchResultResult) > 0) {
                        ...
                        $frenchHighestScore = $highestScores['test_french2'];
                        $frenchLowestScore = $lowestScores['test_french2'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($artResultResult) > 0) {
                        ...
                        $artHighestScore = $highestScores['test_artcraft2'];
                        $artLowestScore = $lowestScores['test_artcraft2'];
