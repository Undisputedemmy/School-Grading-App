...
LEFT JOIN mathematics mr ON sd.id = mr.student_id
LEFT JOIN english er ON sd.id = er.student_id
LEFT JOIN bst ec ON sd.id = ec.student_id
LEFT JOIN pvs ph ON sd.id = ph.student_id
LEFT JOIN nv ch ON sd.id = ch.student_id
LEFT JOIN crs cr ON sd.id = cr.student_id
LEFT JOIN business co ON sd.id = co.student_id
LEFT JOIN yoruba yo ON sd.id = yo.student_id
LEFT JOIN history hi ON sd.id = hi.student_id
LEFT JOIN artcraft ac ON sd.id = ac.student_id
LEFT JOIN cca cc ON sd.id = cc.student_id
LEFT JOIN french fr ON sd.id = fr.student_id
