...
if (isset($_POST['submit'])) {
    ...
    $getmidtermScoreScoreQuery = "SELECT COALESCE(total_score, 0) AS midterm_score FROM test_pvs1 WHERE 
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    $checkQuery = "SELECT * FROM pvs1 WHERE student_id = '$studentDetailsId'";
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
      ...
      $sql = "INSERT INTO pvs1 (student_id, midterm_score, exam_score, terminal_score, student_grade)
