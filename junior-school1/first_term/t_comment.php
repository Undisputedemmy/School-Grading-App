...
$predefinedComments = [
    ...
    "Talks and shares ideas during class discussions.",
    "Works well with friends during group activities.",
    "Tries really hard on tough tasks and never gives up.",
    "Does more than expected in class activities.",
    ...
    "Stays positive even when things are a bit tough.",
...
if (isset($_POST['submit'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the comment already exists in the t_comment1 table for the given student
        $checkQuery = "SELECT * FROM t_comment1 WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the comment into the t_comment1 table with the associated student ID
            $sql = "INSERT INTO t_comment1 (student_id, teacher_comments, teacher_name, date)
