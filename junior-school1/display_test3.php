...
include './ca_test3/position.php';
include './ca_test3/lowest_percentage.php';
            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($bstResultResult) > 0) {
                        ...
                        $bstHighestScore = $highestScores['test_bst3'];
                        $bstLowestScore = $lowestScores['test_bst3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($pvsResultResult) > 0) {
                        ...
                        $pvsHighestScore = $highestScores['test_pvs3'];
                        $pvsLowestScore = $lowestScores['test_pvs3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($nvResultResult) > 0) {
                        ...
                        $nvHighestScore = $highestScores['test_nv3'];
                        $nvLowestScore = $lowestScores['test_nv3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($busResultResult) > 0) {
                        ...
                        $busHighestScore = $highestScores['test_business3'];
                        $busLowestScore = $lowestScores['test_business3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($ccaResultResult) > 0) {
                        ...
                        $ccaHighestScore = $highestScores['test_cca3'];
                        $ccaLowestScore = $lowestScores['test_cca3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($frenchResultResult) > 0) {
                        ...
                        $frenchHighestScore = $highestScores['test_french3'];
                        $frenchLowestScore = $lowestScores['test_french3'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($artResultResult) > 0) {
                        ...
                        $artHighestScore = $highestScores['test_artcraft3'];
                        $artLowestScore = $lowestScores['test_artcraft3'];
