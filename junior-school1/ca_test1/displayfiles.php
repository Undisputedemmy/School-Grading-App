...
if (isset($_GET['admission_no'])) {
    ...
    $pvsResultQuery = "SELECT ph.*, sd.admission_no, sd.name, sd.class FROM test_pvs1 ph, student_details sd WHERE sd.id = ph.student_id AND sd.admission_no = '$studentId'";
    ...
    $nvResultQuery = "SELECT ch.*, sd.admission_no, sd.name, sd.class FROM test_nv1 ch, student_details sd WHERE sd.id = ch.student_id AND sd.admission_no = '$studentId'";
    ...
    $bstResultQuery = "SELECT ec.*, sd.admission_no, sd.name, sd.class FROM test_bst1 ec, student_details sd WHERE sd.id = ec.student_id AND sd.admission_no = '$studentId'";
    ...
    $busResultQuery = "SELECT co.*, sd.admission_no, sd.name, sd.class FROM test_business1 co, student_details sd WHERE sd.id = co.student_id AND sd.admission_no = '$studentId'";
    ...
    // Retrieve the basic tech from the nv table
    $ccaResultQuery = "SELECT cc.*, sd.admission_no, sd.name, sd.class FROM test_cca1 cc, student_details sd WHERE sd.id = cc.student_id AND sd.admission_no = '$studentId'";
