...
if (isset($_POST['submit'])) {
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Check if the scores already exist in the test_business table for the given student
    $checkQuery = "SELECT * FROM test_business1 WHERE student_id = '$studentDetailsId'";
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
      ...
      // Insert the result into the test_business table with the associated student ID
      $sql = "INSERT INTO test_business1 (student_id, class_exercise, assignment, total_score, test, student_grade)
      ...
      if ($res) {
        ...
        $message = "test_business scores submitted successfully!";
...
<body>
  <div class="container my-2">
    <h1> test_business Scores</h1>
    <?php if (!empty($message)) : ?>
      <div class="alert alert-success" role="alert">
        <?php echo $message; ?>
      </div>
    <?php endif; ?>
    <form method="POST" class="col-md-6" <?php if ($disabled) echo "disabled"; ?>>
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
