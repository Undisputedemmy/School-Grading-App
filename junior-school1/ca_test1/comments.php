...
if (isset($_POST['submit'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if the Remarks already exist in the test_others1 table for the given student
        $checkQuery = "SELECT * FROM test_others1 WHERE student_id = '$studentDetailsId'";
        ...
        if ($checkResult && mysqli_num_rows($checkResult) > 0) {
            ...
            // Insert the Remarks into the test_others1 table with the associated student ID
            $sql = "INSERT INTO test_others1 (student_id, principal_remarks, principal_name, date)
