...
include './first_term/positions.php';
include './first_term/lowest_percentage.php';
            ...
            <table style="border: 2px solid;">
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($bstResultResult) > 0) {
                        ...
                        $bstHighestScore = $highestScores['bst1'];
                        $bstLowestScore = $lowestScores['bst1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($pvsResultResult) > 0) {
                        ...
                        $pvsHighestScore = $highestScores['pvs1'];
                        $pvsLowestScore = $lowestScores['pvs1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($nvResultResult) > 0) {
                        ...
                        $nvHighestScore = $highestScores['nv1'];
                        $nvLowestScore = $lowestScores['nv1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($busResultResult) > 0) {
                        ...
                        $busHighestScore = $highestScores['business1'];
                        $busLowestScore = $lowestScores['business1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($ccaResultResult) > 0) {
                        ...
                        $ccaHighestScore = $highestScores['cca1'];
                        $ccaLowestScore = $lowestScores['cca1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($frenchResultResult) > 0) {
                        ...
                        $frenchHighestScore = $highestScores['french1'];
                        $frenchLowestScore = $lowestScores['french1'];
                ...
                <tr>
                    ...
                    if (mysqli_num_rows($artResultResult) > 0) {
                        ...
                        $artHighestScore = $highestScores['artcraft1'];
                        $artLowestScore = $lowestScores['artcraft1'];
